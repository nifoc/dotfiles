...
in
{
  ...
  xdg.configFile."rift/config.toml".text = /* toml */ ''
    [settings]
    # Animations
    ...
    app_rules = [
      { app_id = "com.apple.ScreenSharing", floating = true },
      { app_id = "com.apple.systempreferences", floating = true },
      { app_id = "com.bitwarden.desktop", floating = true },
      { app_id = "com.colliderli.iina", floating = true },
      { app_id = "com.haystacksoftware.Arq", floating = true },
      { app_id = "com.jonny.mona", floating = true },
      { app_id = "com.kapeli.dash-setapp", floating = true },
      { app_id = "com.macpaw.Gemini-setapp", floating = true },
      { app_id = "com.runningwithcrayons.Alfred", floating = true },
      { app_id = "com.tapbots.Ivory", floating = true },
      { app_id = "net.pornel.ImageOptim", floating = true },
    ]
    ...
    "mod + 0" = { switch_to_workspace = 0 }
    "mod + 1" = { switch_to_workspace = 1 }
    "mod + 2" = { switch_to_workspace = 2 }
    "mod + 3" = { switch_to_workspace = 3 }

    "hyper + 0" = { move_window_to_workspace = 0 }
    "hyper + 1" = { move_window_to_workspace = 1 }
    "hyper + 2" = { move_window_to_workspace = 2 }
    "hyper + 3" = { move_window_to_workspace = 3 }

    "hyper + Tab" = "switch_to_last_workspace"

    "hyper + Left" = { join_window = "left" }
    "hyper + Right" = { join_window = "right" }
    "hyper + Up" = { join_window = "up" }
    "hyper + Down" = { join_window = "down" }
    "hyper + Comma" = "stack_windows"
    "hyper + Slash" = "unstack_windows"
    "hyper + E" = "unjoin_windows"

    "hyper + T" = "toggle_window_floating"
    "hyper + F" = "toggle_fullscreen"

    # smartly resize windows
    "hyper + Equal" = "resize_window_grow"
    "hyper + Minus" = "resize_window_shrink"
    ...
    "mod + D" = "debug" # prints layout tree

    "hyper + S" = "serialize"
    "hyper + Q" = "save_and_exit"
  '';
