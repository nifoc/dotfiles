...
in
{
  ...
  nvim-web-devicons = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0db6a106d0fba1b54ff2b7f9db108e7505a4c26f";
      sha256 = "0qj7nfkxphyl952sa58rxbxk1r34v8y7pk0wd2528hmkxslv8wv6";
      fetchSubmodules = false;
    };
  };
  ...
  nvim-treesitter = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      rev = "57205313dda0ac82ac69e21d5e2a80f3297c14cc";
      sha256 = "1ab9am3gn0n1jpm2hgchdr18ib1rxq57vi8y488kkfaa0ib6s3ym";
      fetchSubmodules = false;
    };
  };
  ...
  telescope-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "1jm2ycznj0nc3vrql7vqhh927hzlaybijmpfn72hjc9wrh84dslb";
      fetchSubmodules = false;
    };
  };
  ...
  nvim-lspconfig = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "1ii6i1d5wzhiry5d82wsly5krgmwq3hm2n17lk5aiilws8pbq6xi";
      fetchSubmodules = false;
    };
  };
  ...
  schemastore-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      rev = "b788bde023f9fbc2eb86e89d32c0bf98a60ae406";
      sha256 = "1zlm47ryw6y000k6dpab2dlllvs9ihrlj806avrmyrv1dqmcw3dy";
      fetchSubmodules = false;
    };
  };
  ...
  conform-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "conform.nvim";
      rev = "5a15cc46e75cad804fd51ec5af9227aeb1d1bdaa";
      sha256 = "0mw8jw5k7miiwinrvd05mqxggrm0lkmdd5j5fgi9p0jcx2k4j360";
      fetchSubmodules = false;
    };
  };
  ...
  oil-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "oil.nvim";
      rev = "18dfd2458dc741fea683357a17aaa95870b25a3c";
      sha256 = "141kxa178r5fd3pi5i5b0q16a9ccs1d5765c93bp8s6qlaaf0mca";
      fetchSubmodules = false;
    };
  };
