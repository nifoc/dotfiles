...
in
{
  ...
  nvim-treesitter = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "14f3miakf4dwsy01b10rd80p989ar5bcmn6mhv2x8a6ibys2a1d9";
      fetchSubmodules = false;
    };
  };
  ...
  nvim-lspconfig = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "1nnj1xdfba23b53sl37f4j4v91l3sn9bxw6z3h3v9ikggq543zfh";
      fetchSubmodules = false;
    };
  };
  ...
  schemastore-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "0hxm2c55yf508slk39kzblb0r2v30ar2x3xf4mf5c4ysmb4h98v4";
      fetchSubmodules = false;
    };
  };
  ...
  gitsigns-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "1s4rw3n8h91djslr0bi9rq9j429jiynn4bn4aqcqgi9bnvf77da0";
      fetchSubmodules = false;
    };
  };
  ...
  neogit = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      owner = "NeogitOrg";
      repo = "neogit";
      rev = "d6f5bdd4344d3f07fb6932834f9009b55eb8a511";
      sha256 = "00ib5224ik3f7vrl671bj9i01xrk4smd8ipjdi6frm8qccxbcv37";
      fetchSubmodules = false;
    };
  };
