...
in
{
  ...
  nvim-treesitter = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "0fp2jx17kp559k76lsb8zmlsy41cqyvqy1ad9k5w6yaanslq4bs3";
      fetchSubmodules = false;
    };
  };
  rainbow-delimiters-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      rev = "c097f728a409d9923a3c70c1507e8389978a9b85";
      sha256 = "1lzl39q5s1s07g4sgf8fghm9rcsgba7mj37prqf48c8sg2j2dklv";
      fetchSubmodules = false;
    };
  };
  ...
  nvim-lspconfig = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "10p4qr3ncm4z122wlibyl74dhrhwvlcs7af5r2ri647h63skcrv6";
      fetchSubmodules = false;
    };
  };
  ...
  schemastore-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0d18cb5f8faf160335b4ed4699b6b35c616de5b9";
      sha256 = "1i0xs60s9n8bhr7f3gwprgh8nwdgij9gqnhmx43w4zwh923xirmg";
      fetchSubmodules = false;
    };
  };
  ...
  nvim-lint = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "0c2blk4i768wdl27jxz31srmq0d1936kd7972w54l66hk3mv301y";
      fetchSubmodules = false;
    };
  };
  ...
  conform-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "conform.nvim";
      rev = "667102f26106709cddd2dff1f699610df5b94d7f";
      sha256 = "0bpzfihbl5cwlya6v217w65wg9zls7rsqpir03y5dh70f6yihk8h";
      fetchSubmodules = false;
    };
  };
  nvim-autopairs = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "017nx03jypf38wrbiqzr5jpscp57mxdfwsmgpmhpc100hvy6n2r8";
      fetchSubmodules = false;
    };
  };
