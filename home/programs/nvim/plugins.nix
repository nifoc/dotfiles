...
in
{
  ...
  nvim-treesitter = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      rev = "122b4d3db1616c1f1305b847c5ed2217c4c329f1";
      sha256 = "19za7hik2ywkyh6w1lmbdziv3rbv9xqrky5jlwfaj87m4rwmfvjw";
      fetchSubmodules = false;
    };
  };
  ...
  telescope-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "0mh0sr5iz9hxm74k27c4hvxzxwv7z27zb1xdfhk0rxmzhd2vgx6i";
      fetchSubmodules = false;
    };
  };
  ...
  nvim-lspconfig = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      owner = "neovim";
      repo = "nvim-lspconfig";
      rev = "9baca6a403b3b2098224010fda6ff5615ae6e782";
      sha256 = "04zscgrz6c53rhfxm3gzprfamh02phif7h2966mzp3vr916ji2ql";
      fetchSubmodules = false;
    };
  };
  ...
  schemastore-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      rev = "e33d8db3fdc0ac7be4ba5312feb4fc1972087eee";
      sha256 = "028wqchj6kd718q571w2w8qq0ml9gj68x3x3bv1dcf4giv85xkl0";
      fetchSubmodules = false;
    };
  };
  ...
  gitsigns-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "1ypszmvklxwvnisnhqdk7y55x24705s7h6d518kz0j56k1j0aibv";
      fetchSubmodules = false;
    };
  };
