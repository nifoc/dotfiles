...
in
{
  ...
  nvim-web-devicons = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "15f6vgngs4d5sj244fzg461zm5px3pl6dm5c9la3h94mqpv0ms9n";
      fetchSubmodules = false;
    };
  };
  ...
  nvim-treesitter = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "0x6aj991mjagfc8mlazia8rkrkl1gybv8r0wmk0608kpx1ijm28l";
      fetchSubmodules = false;
    };
  };
  ...
  schemastore-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "0vq920xi6kzyvqr8gg2rvqz27pcfpj6wmg02xpiv4vds1xxg7lgl";
      fetchSubmodules = false;
    };
  };
  ...
  conform-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      owner = "stevearc";
      repo = "conform.nvim";
      rev = "069e971295a34a810484b7b2ef54b3c735214181";
      sha256 = "04bg9z520sx9yasbnjz06412sz8228wf04rs7hzgrfsjasfq0pyh";
      fetchSubmodules = false;
    };
  };
  ...
  nvim-surround = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      owner = "kylechui";
      repo = "nvim-surround";
      rev = "ae876ab0f8d41213131c3ed4eeb4c48328f45e12";
      sha256 = "1r9fvjpd0gfwxyjx29h7472x3dd07xgljc3m3rfqvmrj6p4y48l5";
      fetchSubmodules = false;
    };
  };
  oil-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "1s8psv2p1167jqxg5zsj8qd5ch20lb2vjw8vlansnkqz5cwak1c0";
      fetchSubmodules = false;
    };
  };
  ...
  gitsigns-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      owner = "lewis6991";
      repo = "gitsigns.nvim";
      rev = "379a5a915aea3e9ba0d4a778e8478584ac0f9011";
      sha256 = "1r7dpym9y3s2a3vpq3gil9gyp6460i5lf09gcm1sm1pqyjwl3mxp";
      fetchSubmodules = false;
    };
  };
  ...
  which-key-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "0zm9vgnb1wqjfl1mhk3ciplngqkasg6m51nyz59n5diaxv5lhwfp";
      fetchSubmodules = false;
    };
  };
}
