...
{ pkgs, ... }:
{
  ...
  nvim-osc52 = pkgs.vimUtils.buildVimPluginFrom2Nix {
    ...
    src = pkgs.fetchFromGitHub {
      owner = "ojroques";
      repo = "nvim-osc52";
      rev = "ccd4996df43dcaae062dfefbe54a2db2371b16c0";
      sha256 = "05n2d9xsm8lx7srnz36wky894hw34rnssgh51b18fxaq066mx4w0";
      fetchSubmodules = false;
    };
  };
  ...
  leap-nvim = pkgs.vimUtils.buildVimPluginFrom2Nix {
    ...
    src = pkgs.fetchFromGitHub {
      owner = "ggandor";
      repo = "leap.nvim";
      rev = "801884c7de8ffeb64adb700c8685aa98d67e64bb";
      sha256 = "1nkfilxpknifxjql3lmm3difkffpvgk51jcqir1ncrnpsvmsh7r5";
      fetchSubmodules = false;
    };
  };
  ...
  nvim-lint = pkgs.vimUtils.buildVimPluginFrom2Nix {
    ...
    src = pkgs.fetchFromGitHub {
      owner = "mfussenegger";
      repo = "nvim-lint";
      rev = "1d597b89bd679a8f6c930aa1ad9715b2c058aa4d";
      sha256 = "1gsgj2hkfs5v8049bpgkg2fg1zvl0sg4bbbjmi9f826m0kgr78qi";
      fetchSubmodules = false;
    };
  };
  comment-nvim = pkgs.vimUtils.buildVimPluginFrom2Nix {
    ...
    src = pkgs.fetchFromGitHub {
      owner = "numtostr";
      repo = "comment.nvim";
      rev = "4818a4c2ecf64ace6358b81073ad5d76f657953d";
      sha256 = "10kkzs14903c8bn4ynhd8mgifkbqf5sach80svnxs493wlw4xkgp";
      fetchSubmodules = false;
    };
  };
  LuaSnip = pkgs.vimUtils.buildVimPluginFrom2Nix {
    ...
    src = pkgs.fetchFromGitHub {
      owner = "L3MON4D3";
      repo = "LuaSnip";
      rev = "b8fa22fc12df7a8c48f5c18156874d40f584265c";
      sha256 = "0md6bj891nk1v5743v3n69wb8j9r75x3mnpq186ykwcqmhxfhhra";
      fetchSubmodules = false;
    };
  };
  ...
  nvim-treesitter-textobjects = pkgs.vimUtils.buildVimPluginFrom2Nix {
    ...
    src = pkgs.fetchFromGitHub {
      ...
      rev = "a264d5a1e070188dda9cf98d59681cff0b9a56ff";
      sha256 = "065ckqknp6rig3s2zzcqpddsfhxknb2264vr3k7x84qaq99clnj0";
      fetchSubmodules = false;
    };
  };
  ...
  bufferline-nvim = pkgs.vimUtils.buildVimPluginFrom2Nix {
    ...
    src = pkgs.fetchFromGitHub {
      ...
      rev = "dd2addade63c977bae47f1b2abe9ef503df1b4d8";
      sha256 = "0dcgddsx6grsi1yvpng2717jkpm3hpr4pjw7siayr7sax7xy7myp";
      fetchSubmodules = false;
    };
  };
