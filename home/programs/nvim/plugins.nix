...
in
{
  ...
  nvim-web-devicons = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1736cb81bdc42e1ee206081a161bdb2af68fb7a1";
      sha256 = "16qx72yx3nl9hdx31j1fw32dx18gh5yca4vmgnxji653xr7x7gym";
      fetchSubmodules = false;
    };
  };
  ...
  rainbow-delimiters-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      rev = "8d9a5debf473658c0d1d73fcb51bad1d9aecbf75";
      sha256 = "0r63grpalkrp2pqgakd3z70qgcsn4acab35fxzdav1bz115mm16y";
      fetchSubmodules = false;
    };
  };
  ...
  nvim-lspconfig = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      owner = "neovim";
      repo = "nvim-lspconfig";
      rev = "ae8a01bb40848490548e5d07b97ed972ed43c2f9";
      sha256 = "05vaqp22g91n5rih1skz3ckryvwvpglq7kghpns3ydvwl46n2dh2";
      fetchSubmodules = false;
    };
  };
  ...
  neogit = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      owner = "NeogitOrg";
      repo = "neogit";
      rev = "cfea08ebb2fda22f1357e413d4ea45dcda6fcab5";
      sha256 = "137vq8lgqjzwl3kizmg63hrn3v8kd56a876z0faizxmj24jv0m1n";
      fetchSubmodules = false;
    };
  };
  ...
  which-key-nvim = buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "1mhlfkqj09cqkzabgs0amyyyr8z1m9mjqbjv2wncir8ahlpmgm56";
      fetchSubmodules = false;
    };
  };
}
