  ...
  systemd.services = {
    forgejo-runner-nix-image = {
      ...
      script = ''
        ...
        substituters = https://nix-cache.kempkens.network/nifoc-ci?priority=1 https://nix-community.cachix.org?priority=50 https://cache.garnix.io?priority=60 https://cache.nixos.org/
        trusted-public-keys = nifoc-ci:YGmPyqh3kbF7eQhMX9esbQpdYU4f3Q+WEx+sv97KKHo= nix-community.cachix.org-1:mB9FSh9qf2dCimDSUo8Zy7bkq5CX+/rkCWyvRCYg3Fs= cache.garnix.io:CTFPyKSLcx5RMJKfLo5EEPUObbA78b0YQ2DTCJXqr9g= cache.nixos.org-1:6NCHdD59X431o0gWypbMrAURkbJ16ZPMQFGspcDShjY=
        NIX_CONFIG
