  ...
  den.aspects.oidc-provider = {
    nixos =
      ...
      in
      {
        ...
        age.secrets = {
          oidc-provider-encryption-key = {
            file = ../../agenix/oidc-provider/encryption-key.age;
          };

          geoip-updater-license = {
            file = lib.mkDefault ../../agenix/geoip-updater/license.age;
          };
        };
        ...
        services = {
          pocket-id = {
            ...
            credentials = {
              ENCRYPTION_KEY = config.age.secrets.oidc-provider-encryption-key.path;
              MAXMIND_LICENSE_KEY = config.age.secrets.geoip-updater-license.path;
            };
