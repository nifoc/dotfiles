...

{
  ...
  den.aspects.daniel = {
    meta = {
      fullname = "Daniel Kempkens";
      email = "daniel@kempkens.io";

      sshKeys = {
        DanielsPhone = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAINeao6TJuTFgU8X7xpDXiXMlQ7NY47C2JJp7nFlt5jnD";
    ...
    nixos =
      ...
      let
        ...
        uid = (cfg.primaryUid or null);
        gid = (cfg.primaryGid or null);
      in
      {
        imports = [ inputs.agenix.nixosModules.default ];

        age.secrets = {
          users-daniel-password = {
            file = ../../../agenix/users/daniel/password.age;
          };
        };
        ...
        users = {
          ...
          users.daniel = {
            inherit uid;
            hashedPasswordFile = config.age.secrets.users-daniel-password.path;
            isNormalUser = true;
            home = "/home/daniel";
            description = "Daniel";
            extraGroups = [ "wheel" ];
